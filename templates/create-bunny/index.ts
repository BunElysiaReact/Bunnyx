...
// @bunnyx/api is auto-generated by \`bunnyx dev\` from your Elysia App type
  ...
  return (
    <main style={{ padding: '2rem', fontFamily: 'system-ui', maxWidth: '680px', margin: '0 auto' }}>
      ...
      <p style={{ color: '#6b7280', marginBottom: '2rem', fontSize: '0.9rem' }}>
        BertUI + Elysia via Bunnyx · <code style={{ background: '#f3f4f6', padding: '0.1em 0.4em', borderRadius: 4 }}>@bunnyx/api</code> is active
      </p>
